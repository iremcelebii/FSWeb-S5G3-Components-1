...
*/
// function haberYapici(obje) {
//   return `
//   <div class="article">
//   <h2>${obje.baslik}</h2>
//   <p class="tarih">${obje.tarih}</p>
//   <p>${obje.ilkParagraf}</p>
//   <p>${obje.ikinciParagraf}</p>
//   <p>${obje.ucuncuParagraf}</p>
//   <span class="expandButton" onclick="console.log("document.querySelector("div.article"))" >+</span>
// </div>
//   `;
// }
// const genelDiv = document.querySelector(".articles");
// data.forEach((haber) =>
//   genelDiv.insertAdjacentHTML("beforeend", haberYapici(haber))
// );
...
function haberYapici(obje) {
  ...
  const newTarih = document.createElement("p");
  newTarih.setAttribute("class", "tarih");
  ...
  newHeading.textContent = obje.baslik;
  newTarih.textContent = obje.tarih;
  paragraf1.textContent = obje.ilkParagraf;
  paragraf2.textContent = obje.ikinciParagraf;
  paragraf3.textContent = obje.ucuncuParagraf;
...
const yeniHaber = {
  baslik: "yeni haber",
  tarih: "31 Ocak 2023",
  ilkParagraf: `hehhehehehe `,

  ikinciParagraf: `pehehehhehe `,

  ucuncuParagraf: `hahahahaah`,
};

data.push(yeniHaber);
console.log(data);
data.forEach((haber) => genelDiv.appendChild(haberYapici(haber)));
